...
{
public:
virtual std::uint8_t getSizeX() const override { return
static_cast<std::uint8_t>(m_sizeX); }
virtual std::uint8_t getSizeY() const override { return
static_cast<std::uint8_t>(m_sizeY); }
...
void compareStates(const LifeSimulator& simulation, const State& update, const int&
updateNum)
{
